...
alpha = 0.6; %cota pentru functia de crossover_singular()
sigma = 0.1; %deviatia standard pentru mutatie_fluaj() 
...
while it <= MAX && nrg <= NrG && OK
        ...
        Copii = crossover_pop(Parinti,dim,n,pc,cost,valoare,cmax,alpha);
        
        % Operatia de mutare a Populatiei de copii
        CopiiM = mutatie_pop(Copii,dim,n,cost,valoare,cmax,pm,sigma);
