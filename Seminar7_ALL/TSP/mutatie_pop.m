...
% Implementarea operatiei de mutatie la nivelul unei populatii (de copii)
% Reprezentarea - permutari
% Populatia - O, cu dim indivizi; n -dimensiunea problemei(numarul de orase)
% C- matricea distantelor (costurilor)
% pm - probabilitatea de mutatie - in general foarte mica

% intial, populatia mutanta este identica cu O
OM=O;
